...
# Troubleshooting CrateDB

Analyze CrateDB shard distribution across nodes and availability
zones, and generate safe SQL commands for shard rebalancing and
...
You can test your connection configuration with the included test program.
